...
const CalculationsDisplay = ({ ingredients, targetMargin = 30, sellingPrice = 0 }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-green-50 via-purple-50 to-green-50 border-2 border-green-200 rounded-2xl p-6 shadow-lg">
      <h3 className="text-lg font-bold text-gray-900 mb-4">Summary</h3>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 border border-purple-100">
          <div className="text-sm text-gray-600 mb-1 font-medium">Cost per Drink</div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 border-2 border-purple-300 shadow-md">
          ...
          <div className="text-2xl font-bold bg-gradient-to-r from-green-500 to-purple-600 bg-clip-text text-transparent">${suggestedPrice.toFixed(2)}</div>
        </div>
        <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 border border-purple-100">
          <div className="text-sm text-gray-600 mb-1 font-medium">Pour Cost</div>
