...
const IngredientForm = ({ onAdd, initialValue }) => {
  ...
  const [packageUnit, setPackageUnit] = useState('fl oz')
  const [quantityUsed, setQuantityUsed] = useState('')
  const [quantityUnit, setQuantityUnit] = useState('fl oz')
  ...
  useEffect(() => {
    if (initialValue) {
      ...
      setPackageCost('')
      setPackageSize('')
      setPackageUnit('fl oz')
      setQuantityUsed('')
      setQuantityUnit('fl oz')
      setUnitCost('')
      setQuantity('')
      setUnit('fl oz')
    }
    ...
    <div className="bg-gradient-to-br from-green-50/50 to-purple-50/50 p-5 rounded-2xl border-2 border-green-200 backdrop-blur-sm">
      ...
      <div className="mb-4">
        <div className="flex items-center justify-between mb-2">
          <label className="block text-sm font-semibold text-gray-700">Spirit or Mixer Name</label>
        ...
        <div className="flex gap-2">
          <input
            type="text"
            placeholder="Spirit or mixer name"
            value={name}
        ...
        <TemplateSelector
          onSelectTemplate={(template) => {
            ...
            const ingredient = {
              ...
              unit: template.templateYieldUnit || template.unit || 'fl oz',
              package_cost: null,
              package_size: null,
              package_unit: null
            }
