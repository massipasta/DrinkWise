  ...
  if (!ingredients || ingredients.length === 0) {
    return (
      <div className="text-center py-12 bg-gray-50 rounded-xl border-2 border-dashed border-gray-300">
        ...
        <p className="text-gray-500 font-medium">No spirits/mixers added yet</p>
        <p className="text-gray-400 text-sm mt-1">Add spirits and mixers to calculate costs</p>
      </div>
    )
  }
              ...
              <div className="text-sm text-gray-600 space-y-1">
                ...
                <div className="flex items-center gap-2">
                  <span className="bg-gray-100 px-2 py-1 rounded-md font-medium">
                    {ingredient.quantity} {ingredient.unit || 'fl oz'}
                  </span>
                  <span>used</span>
                  <span>=</span>
