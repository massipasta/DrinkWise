...
const InvoiceReview = ({ items, onApprove, onBack, onCancel }) => {
  ...
  const handleEdit = (item) => {
    ...
    setEditedItems({
      ...editedItems,
      [item.id]: { name: itemData.name, price: itemData.price, unit: itemData.unit || 'fl oz' }
    })
  }
    ...
    const approved = items
      ...
      .map(item => {
        ...
        return {
          ...
          quantity: 1,
          unit: edited?.unit || itemData.unit || 'fl oz'
        }
      })
    onApprove(approved)
  }
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                          <label className="text-xs text-gray-600 mb-1 block">Spirit/Mixer Name</label>
                          {isEditing ? (
                            <input
                              type="text"
                              value={itemData.name}
                        ...
                        <div>
                          ...
                          {isEditing ? (
                            ...
                            <div className="font-semibold text-gray-900">{itemData.unit || 'fl oz'}</div>
                          )}
                        </div>
                      </div>
          ...
          <div className="flex justify-between items-center gap-4">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="px-6 py-3 bg-gradient-to-r from-green-400 to-purple-600 text-white rounded-xl hover:from-green-500 hover:to-purple-700 font-bold shadow-lg hover:shadow-xl transition-all transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
              >
