          ...
          {showMenuForm ? (
            ...
            <div className="mb-6">
              <button
                ...
                className="px-4 py-2 bg-gradient-to-r from-green-400 to-purple-600 text-white rounded-lg hover:from-green-500 hover:to-purple-700 font-semibold transition-all flex items-center gap-2"
              >
