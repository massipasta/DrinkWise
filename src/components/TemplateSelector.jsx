  ...
  const handleSelect = (template) => {
    try {
      ...
      const templateData = {
        ...
        unit: template.yield_unit || 'fl oz',
        isTemplate: true,
        templateId: template.id,
        templateYield: template.total_yield,
        templateYieldUnit: template.yield_unit || 'fl oz'
      }
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full max-h-[80vh] overflow-hidden flex flex-col">
        <div className="p-6 border-b border-gray-200 flex justify-between items-center">
          <div>
            <h3 className="text-xl font-bold text-gray-900">Select Spirit/Mixer Template</h3>
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-sm text-gray-400">Create templates to reuse spirit/mixer combinations or upload an invoice to import spirits/mixers.</p>
            </div>
          ) : (
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-gray-500">
                          ...
                          {template.ingredients?.length > 0 && (
                            <span className="ml-2">• {template.ingredients.length} spirits/mixers</span>
                          )}
                        </div>
                      </div>
